// ============================================================
// CAS SERVICE — DISABLED (CAS.ai removed DramaHub)
// To re-enable: uncomment the original imports and class body
// and restore clever_ads_solutions in pubspec.yaml
// ============================================================
...
class CasService extends GetxService {
  ...
  void refreshAdLoad() {}
  Future<void> showAppOpen() async {}
  Future<bool> showInterstitialFallback() async => false;
  Future<bool> showRewardedFallback({
    required VoidCallback onRewarded,
    VoidCallback? onNotAvailable,
  }) async {
