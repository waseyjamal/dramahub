...
/// Horizontal row showing dramas marked as "coming soon".
/// Hidden automatically when comingSoonDramas list is empty.
/// Zero logic changes from original — pure file move.
class ComingSoonRow extends StatelessWidget {
  final HomeController controller;
  const ComingSoonRow({super.key, required this.controller});

  @override
  Widget build(BuildContext context) {
    return Obx(() {
      final dramas = controller.comingSoonDramas;
