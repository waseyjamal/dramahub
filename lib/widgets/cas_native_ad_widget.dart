// ============================================================
// CAS NATIVE AD WIDGET — DISABLED (CAS.ai removed DramaHub)
// To re-enable: uncomment everything below and restore
// clever_ads_solutions in pubspec.yaml
// ============================================================
...
/// CAS Native Ad Widget — disabled. Replaced by LevelPlayNativeAdWidget.
/// This stub keeps existing imports in screens compiling without changes.
class CasNativeAdWidget extends StatelessWidget {
  final String screenKey;
  const CasNativeAdWidget({super.key, required this.screenKey});
